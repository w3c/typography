...
function addSharedData () {
	// add the shared_data info to the document
	
var sections
sections = ['writing_mode', 'bidi_text', 'fonts', 'glyphs', 'cursive', 'letterforms', 'transforms', 'encoding', 'segmentation', 'punctuation_etc', 'quotations', 'emphasis', 'abbrev', 'inline_notes', 'text_decoration', 'data_formats', 'line_breaking', 'justification', 'spacing', 'baselines', 'lists', 'initials', 'page_layout', 'grids_tables', 'footnotes_etc', 'headers_footers', 'interaction']

for (s=0;s<sections.length;s++) {
	// do the spec links
	if (shared_data[sections[s]] &&
		shared_data[sections[s]].spec_links &&
		document.getElementById('specs-'+sections[s])) {
		console.log("found", 'specs-'+sections[s])
	    for (i=0;i<shared_data[sections[s]].spec_links.length; i++) 			
			document.getElementById('specs-'+sections[s]).innerHTML += 
			`<li><cite>${ shared_data[sections[s]].spec_links[i].spec }</cite>: &nbsp; 
			<a href="${ shared_data[sections[s]].spec_links[i].url }" target="_blank">${ shared_data[sections[s]].spec_links[i].title }</a></li>`
			}

	// do the tests
	if (shared_data[sections[s]] &&
		shared_data[sections[s]].tests &&
		document.getElementById('tests-'+sections[s])) {
		console.log("found", 'tests-'+sections[s])
	    for (i=0;i<shared_data[sections[s]].tests.length; i++) 
	    	document.getElementById('tests-'+sections[s]).innerHTML += 
	    	`<li><a href="${ shared_data[sections[s]].tests[i].url }" target="_blank">${ shared_data[sections[s]].tests[i].title }</a></li>`
			}
		}
	}
...
{
spec: "CSS Writing Modes 3",
title: "Horizontal-in-Vertical Composition: the text-combine-upright property",
url: "https://drafts.csswg.org/css-writing-modes-3/#text-combine-upright",
},
], //spec links

"tests": [
{
title: "CSS Writing Modes: Vertical text",
url: "https://w3c.github.io/i18n-tests/results/writing-mode-vertical"
},
{
title: "CSS Writing Modes: Horizontal in vertical",
url: "https://w3c.github.io/i18n-tests/results/horizontal-in-vertical.html"
},
], //tests
}, //writing_mode
...
url:"https://www.w3.org/TR/html5/dom.html#the-dir-attribute"
},
{
spec: "CSS Writing Modes 3", 
title: " Inline direction and bidirectionality",
url:"https://drafts.csswg.org/css-writing-modes-3/#text-direction"
},
], //spec links
...
"tests": [
{
title: "HTML5: dir basics",
url: "https://w3c.github.io/i18n-tests/results/the-dir-attribute"
},
{
title: "HTML5: dir isolation",
url: "https://w3c.github.io/i18n-tests/results/the-dir-attribute-isolation"
},
{
title: "HTML5: Bidirectional text rendering",
url: "https://w3c.github.io/i18n-tests/results/bidi-text-rendering"
},
{
title: "HTML5: dir=auto",
url: "https://w3c.github.io/i18n-tests/results/the-dir-attribute-auto"
},
{
title: "HTML5: The bdo element",
url: "https://w3c.github.io/i18n-tests/results/the-bdo-element"
},
{
title: "HTML5: The dirname attribute",
url: "https://w3c.github.io/i18n-tests/results/the-dirname-attribute"
},
{
title: "HTML5: Native user interfaces",
url: "https://w3c.github.io/i18n-tests/results/native-user-interfaces"
},
{
title: "CSS Writing Modes: Bidi",
url: "https://w3c.github.io/i18n-tests/results/writing-modes-bidi"
},
], //tests
}, //bidi_text
...
{
spec: "CSS Text", 
title: "Shaping Across Element Boundaries",
url:"https://drafts.csswg.org/css-text/#boundary-shaping"
},
], //spec links
...
"tests": [
{
title: "CSS3 Text, Cursive joining",
url: "https://w3c.github.io/i18n-tests/results/css-text-shaping"
},
{
title: "Exploratory: Cursive behaviour",
url: "https://w3c.github.io/i18n-tests/results/cursive"
},
], //tests
}, //cursive
...
url:"https://drafts.csswg.org/css-fonts/#font-style-prop"
},
{
spec: "CSS Fonts", 
title: "Font weight: the font-weight property",
url:"https://drafts.csswg.org/css-fonts/#font-weight-prop"
},
], //spec links
...
url:"https://drafts.csswg.org/css-text-3/#transforming"
},
{
spec: "", 
title: "CSS Custom Text transformations",
url:"https://specs.rivoal.net/css-custom-tt/"
},
], //spec links
...
"tests": [
{
title: "CSS3 Text: text transform",
url: "https://w3c.github.io/i18n-tests/results/text-transform"
},
], //tests
}, //transforms
...
spec: "HTML5", 
title: "The q element",
url: "https://www.w3.org/TR/html5/text-level-semantics.html#the-q-element"
},
{
spec: "HTML5", 
...
{
spec: "CSS3 Generated and Replaced Content", 
title: "Specifying quotes with the 'quotes' property",
url: "https://www.w3.org/TR/css-content-3/#quotes"
},
], //spec links
...
{
title: "The q element",
url: "https://w3c.github.io/i18n-tests/results/the-q-element.html"
},
], //tests
}, //quotations
...
"spec_links": [
{
spec: "CSS3 Text Decoration", 
title: "Emphasis Marks",
url: "https://drafts.csswg.org/css-text-decor-3/#emphasis-marks"
},
], //spec links
...
"tests": [
{
title: "CSS3 Text decoration, emphasis marks",
url: "https://w3c.github.io/i18n-tests/results/emphasis-marks"
},
], //tests
}, //emphasis
...
"tests": [
{
title: "HTML5: The ruby element and its children",
url: "https://w3c.github.io/i18n-tests/results/ruby-html"
},
{
title: "CSS Ruby",
url: "https://w3c.github.io/i18n-tests/results/css-ruby"
},
], //tests
}, //inline_notes
...
{
spec: "CSS3 Text Decoration", 
title: "Line Decoration: Underline, Overline, and Strike-Through",
url: "https://drafts.csswg.org/css-text-decor-3/#line-decoration"
},
], //spec links
...
"tests": [
{
title: "CSS3 Text decoration, Line decoration",
url: "https://w3c.github.io/i18n-tests/results/line-decoration"
},
], //tests
}, //text_decoration
...
url: "https://drafts.csswg.org/css-text-3/#line-breaking"
},
{
spec: "CSS Text", 
title: "Hyphenation: the hyphens property",
url: "https://drafts.csswg.org/css-text-3/#hyphenation"
},
], //spec links
...
"tests": [
{
title: "CSS Text: Line breaking",
url: "https://w3c.github.io/i18n-tests/results/line-breaking"
},
{
title: "CSS Text: Non-tailorable line breaking",
url: "https://w3c.github.io/i18n-tests/results/line-breaks-glwj"
},
{
title: "CSS Text: Word-break",
url: "https://w3c.github.io/i18n-tests/results/word-break"
},
{
title: "CSS Text: Hyphens",
url: "https://w3c.github.io/i18n-tests/results/hyphens"
},
], //tests
}, //line_breaking
...
url: "https://drafts.csswg.org/css-text-3/#justification"
},
{
spec: "CSS Text", 
title: "Edge effects",
url: "https://drafts.csswg.org/css-text-3/#edge-effects"
},
], //spec links
...
"tests": [
{
title: "CSS3 Text: text-align, text-align-last, text-justify",
url: "https://w3c.github.io/i18n-tests/results/text-align"
},
{
title: "Exploratory tests: Justification & letter-spacing",
url: "https://w3c.github.io/i18n-tests/results/exploring-justify-space"
},
], //tests
}, //justification
...
spec: "CSS Text", 
title: "Spacing",
url: "https://drafts.csswg.org/css-text-3/#spacing"
},
], //spec links
...
title: "Inline-level Alignment",
url: "https://drafts.csswg.org/css-writing-modes-3/#inline-alignment"
},
{
spec: "CSS Inline Layout", 
title: "Line Spacing: the line-height property",
url: "https://drafts.csswg.org/css-inline/#line-height-property"
},
{
spec: "", 
title: "CSS Line Grid",
...
"spec_links": [
{
spec: "CSS Counter Styles", 
title: "Defining Custom Counter Styles: the @counter-style rule",
url: "https://drafts.csswg.org/css-counter-styles/#the-counter-style-rule"
},
{
spec: "CSS Counter Styles", 
title: "Simple Predefined Counter Styles",
url: "https://drafts.csswg.org/css-counter-styles/#predefined-counters"
},
{
spec: "CSS Counter Styles", 
...
url: "https://w3c.github.io/i18n-tests/results/counter-styles"
},
{
title: "CSS3 Counter Styles, predefined styles",
url: "https://w3c.github.io/i18n-tests/results/predefined-counter-styles"
},
{
title: "Custom counter styles",
url: "https://w3c.github.io/i18n-tests/results/custom-counter-styles"
},
], //tests
}, //lists
...
url: "https://www.w3.org/TR/selectors-3/#first-letter"
},
{
spec: "CSS3 Inline Layout", 
title: "Initial Letters",
url: "https://drafts.csswg.org/css-inline/#initial-letter-styling"
},
], //spec links
...
"tests": [
{
title: "CSS3 Selectors: first-letter",
url: "https://w3c.github.io/i18n-tests/results/first-letter-pseudo#latin"
},
{
title: "Interactive test: ::first-letter",
url: "https://github.com/w3c/i18n-tests/wiki/Test-script-for-::first-letter"
},
], //tests
}, //initials
