...
<li>Although I presume this is more a matter for Unicode, but the sorting order regarding digraphs is that those are considered to be different letters; in the order of letters, the digraph immediately follows the first letter. I.e., "c" would be followed by "cs" and before the "d" in the ABC, and the word “cukor” (sugar) would precede the word “csupor” (mug) in a dictionary, because "cs" is a digraph.
</ul>` },
