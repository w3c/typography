var doctitle = "Simplified Chinese and Traditional Chinese for HTML/CSS (Draft)"

var compilers = "The Chinese Layout TF"

var report = {

'encoding': { 'status':'ok', "comments": `` },
'fontstyle': { 'status':'na', "comments": `<p>Not applicable. See <a href="https://github.com/w3c/typography/issues/45">https://github.com/w3c/typography/issues/45</a>.</p>` },
'glyphs': { 'status':'na', "comments": `` },
'cursive': { 'status':'na', "comments": `` },
'boundaries': { 'status':'ok', "comments": `` },
'quotations': { 'status':'ok', "comments": `` },
'numbers': { 'status':'ok', "comments": `` },
'transforms': { 'status':'na', "comments": `` },
'spacing': { 'status':'advanced', "comments": `` },
...
'vertical': { 'status':'advanced', "comments": `` },
